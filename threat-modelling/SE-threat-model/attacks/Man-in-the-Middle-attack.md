...
See attack trees in [Network attacks](https://github.com/tymyrddin/trees/tree/main/network-attacks) and [Application hacking](https://github.com/tymyrddin/trees/tree/main/application-hacking)
