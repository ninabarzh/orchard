...
* [Network attacks](network-attacks)
  ...
  * [Hijack session (network)](network-attacks/Hijack-network-session.md)
  * [Man-in-the-Middle (MitM)](network-attacks/MitM.md)
...
* [Application hacking](application-hacking)
  * [Hijack session (application)](application-hacking/Hijack-application-session.md)
  ...
  * [Man-in-the-Browser (MitB)](application-hacking/MitB.md)
...
* [Web hacking](web-hacking)
  * [Cross-Site Scripting (XSS)](web-hacking/XSS.md)
  * [Cross-Site Request Forgery (CSRF)](web-hacking/CSRF.md)
...
* [Crypto attacks](crypto-attacks)
  ...
  * [Impersonation attack (Group message)](crypto-attacks/Group-impersonation-attack.md)
